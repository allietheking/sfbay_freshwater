...
Public Module ScriptStatTest
    Private Const pTestPath As String = "C:\Projects\20706-ABAG\Model\UCIs-mid-no-dep\EBAYS\"
    Private Const pScenario As String = "EBAYS" '"base"
    ...
    Public Sub ScriptMain(ByRef aMapWin As IMapWin)
        ...
        Dim lHspfBinFileName As String = "ebays.hbn"
