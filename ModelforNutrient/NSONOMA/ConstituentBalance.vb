...
Public Module ScriptStatTest
    Private Const pTestPath As String = "C:\Projects\20706-ABAG\Model\UCIs-mid-no-dep\NSONOMA\"
    Private Const pScenario As String = "NSONOMA" '"base"
    ...
    Public Sub ScriptMain(ByRef aMapWin As IMapWin)
        ...
        Dim lHspfBinFileName As String = "nsonoma.hbn"
