...
Public Module ScriptStatTest
    Private Const pTestPath As String = "C:\Projects\20706-ABAG\Model\UCIs-mid-no-dep\UALAMEDA\"
    Private Const pScenario As String = "UALAMEDA" '"base"
    ...
    Public Sub ScriptMain(ByRef aMapWin As IMapWin)
        ...
        Dim lHspfBinFileName As String = "UALAMEDA.hbn"
        ...
        lLocations.Add("I:201")
        lLocations.Add("I:301")
        lLocations.Add("I:401")
        lLocations.Add("I:501")
        lLocations.Add("I:601")
        lLocations.Add("I:701")
        lLocations.Add("P:101")
        lLocations.Add("P:102")
        lLocations.Add("P:103")
        lLocations.Add("P:104")
        lLocations.Add("P:105")
        lLocations.Add("P:201")
        lLocations.Add("P:202")
        lLocations.Add("P:203")
        lLocations.Add("P:204")
        lLocations.Add("P:205")
        lLocations.Add("P:301")
        lLocations.Add("P:302")
        lLocations.Add("P:303")
        lLocations.Add("P:304")
        lLocations.Add("P:305")
        lLocations.Add("P:401")
        lLocations.Add("P:402")
        lLocations.Add("P:403")
        lLocations.Add("P:404")
        lLocations.Add("P:405")
        lLocations.Add("P:501")
        lLocations.Add("P:502")
        lLocations.Add("P:503")
        lLocations.Add("P:504")
        lLocations.Add("P:505")
        lLocations.Add("P:601")
        lLocations.Add("P:602")
        lLocations.Add("P:603")
        lLocations.Add("P:604")
        lLocations.Add("P:605")
        lLocations.Add("P:701")
        lLocations.Add("P:702")
        lLocations.Add("P:703")
        lLocations.Add("P:704")
        lLocations.Add("P:705")
        lLocations.Add("R:1")
        lLocations.Add("R:2")
        lLocations.Add("R:3")
        lLocations.Add("R:4")
