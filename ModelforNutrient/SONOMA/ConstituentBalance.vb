...
Public Module ScriptStatTest
    Private Const pTestPath As String = "C:\Projects\20706-ABAG\Model\UCIs-mid-no-dep\SONOMA\"
    Private Const pScenario As String = "SONOMA" '"base"
    ...
    Public Sub ScriptMain(ByRef aMapWin As IMapWin)
        ...
        Dim lHspfBinFileName As String = "sonoma.hbn"
